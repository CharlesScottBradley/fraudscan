...
export default function PPPSearchPage() {
  ...
  const [sortBy, setSortBy] = useState('initial_approval_amount');
  ...
  const fetchLoans = async () => {
    ...
    try {
      ...
      setStats(data.stats || { totalAmount: 0, avgLoan: 0, flaggedCount: 0, chargedOffCount: 0 });
    } catch (err) {
      console.error('Failed to fetch PPP loans:', err);
      setError('Failed to load PPP loans. Please try again.');
      setLoans([]);
      setTotalCount(0);
      setTotalPages(0);
    } finally {
    ...
    <div>
      ...
      <div className="font-mono text-sm mb-10">
        ...
        <div className="mt-2 text-gray-400">
          ...
          <p><span className="text-gray-600">├─</span> loans_tracked <span className="text-white ml-4">6.76M</span></p>
          <p><span className="text-gray-600">├─</span> states_covered <span className="text-white ml-4">59</span></p>
      ...
      <div className="flex flex-wrap gap-4 mb-6 text-sm">
        ...
        <div className="flex items-end">
          <label className="flex items-center gap-2 px-3 py-2 border border-gray-700 rounded cursor-pointer hover:border-gray-600">
            ...
            />
            <span className="text-gray-400">Flagged Only</span>
          </label>
        </div>
      ...
      <div className="mb-4 flex items-center justify-between text-sm">
        ...
        {stats.flaggedCount > 0 && !loading && !error && (
          <p className="text-gray-500">
            {stats.flaggedCount.toLocaleString()} flagged in results
          </p>
        )}
      </div>
